{**
  ...
  *
  * @author    PrestaShop SA and Contributors <contect@prestashop.com>
  * @copyright Since 2007 PrestaShop SA and Contributors
 ...
 <footer class="footer row_f">
   ...
   <div class="userfooter">
      <div class="row_f-user">
         ...
         <p class="mamezi right">powered by: <a href="http://mamezi.pl"><img alt="" height="24" src="{$base_dir}/themes/classic/assets/img/mamezi-logo.png" width="62.5" /></a></p>
      </div>
   </div>
 </div>